...
// Exactly the same as headerInProgram.php EXCEPT does not include reminders
?>
<html>
<head>
  <meta charset="UTF-8">
...
<div class = "links">
    ...
    <a class="Manage" href = "cpanel.php" style="float: left;margin-left: 10; margin-right: 20;">Home</a>
